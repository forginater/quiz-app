...
Basic functionality of Clock
    ...
    props: timeLimit, 
*/
export function BattleFieldDirty(props: {timeLimit: number, numQuestions: number}) { 
    /*Phase0: Setup state & getQuestions  */
    const [timerDone, setTimerDone] = useState(false);
    const [outcome, setOutcome] = useState<boolean|undefined>();
    ...
    return (
        <>
            ...
            {true &&
                ...
                <QuizQuestion num1={num1} num2={num2} setOutcome={setOutcome} />
